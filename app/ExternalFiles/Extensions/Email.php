...
class Email extends Extension_Base {
	...
	public function send_mail_after_sync( string $url, array $term_data, int $term_id ): void {
		...
		$body    = sprintf( __( 'The synchronization of %1$s has been successfully completed.', 'external-files-in-media-library' ), esc_html( $term->name ) ) . '<br><br>' . __( 'This email was generated by the WordPress plugin <em>External files in Media Library</em> based on the settings in your project.', 'external-files-in-media-library' );
		$headers = array(
