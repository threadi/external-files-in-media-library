...
class Init {
	 ...
	 * @var Files
	 */
	private Files $external_files_obj;
	...
	private function __construct() {
		...
		$this->external_files_obj = Files::get_instance();
	}
	...
	public function init(): void {
		...
		// schedule.
		add_action( 'eml_check_files', array( Files::get_instance(), 'check_files' ), 10, 0 );

		// attachment-hooks.
		add_filter( 'attachment_link', array( $this, 'get_attachment_link' ), 10, 2 );
		add_action( 'delete_attachment', array( Files::get_instance(), 'log_url_deletion' ), 10, 1 );
		add_action( 'delete_attachment', array( Files::get_instance(), 'delete_file_from_cache' ), 10, 1 );
