...
class Install {
	...
	public function activation(): void {
		...
		if ( ! $transients_obj->get_transient_by_name( 'eml_welcome' )->is_dismissed() ) {
			...
			$message = sprintf( __( '<strong>You have installed <i>External files in media library</i> - great and thank you very much!</strong> Let us show you how it works or immediately add external URLs to your media library <a href="%1$s">here</a>.', 'external-files-in-media-library' ), esc_url( Helper::get_add_media_url() ) ) . '<br><br>';
