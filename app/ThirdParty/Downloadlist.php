...
class Downloadlist extends ThirdParty_Base implements ThirdParty {
	...
	public function init(): void {
		...
		add_filter( 'eml_add_dialog', array( $this, 'add_option_for_list_import' ) );
		add_action( 'eml_after_file_save', array( $this, 'save_file_in_list' ) );
	}
	...
	public function add_action_before_sync( string $url, array $term_data, int $term_id ): void {
		...
		// add hooks.
		add_action( 'eml_after_file_save', array( $this, 'move_file_to_list' ) );
	}
