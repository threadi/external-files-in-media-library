 ...
 */
class SetCompleteCapabilitySet extends externalFilesTests {
	/**
	...
	public function test_set_capability_set(): void {
		...
		$capability_set = \ExternalFilesInMediaLibrary\Plugin\CapabilitySets::get_instance()->get_capability_set_by_name( 'complete' );
		$this->assertIsObject( $capability_set );
		$this->assertInstanceOf( '\ExternalFilesInMediaLibrary\Plugin\CapabilitySet_Base', $capability_set );
