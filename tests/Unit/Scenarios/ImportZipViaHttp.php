 ...
 */
class ImportZipViaHttp extends externalFilesTests {
	/**
	...
	public function test_import_zip_via_http(): void {
		...
		// get the file object.
		$external_file_object = \ExternalFilesInMediaLibrary\ExternalFiles\Files::get_instance()->get_file_by_url( self::get_test_file( 'zip', 'http' ) );
		...
		$this->assertEquals( self::get_test_file( 'zip', 'http' ), $external_file_object->get_url( true ) );
	}
	 ...
	 * @return void
	 */
	public function test_import_faulty_zip_via_http(): void {
